...
from ai_art_creation.prompts.prompt_path_info import object_pattern_pickle_file_path
from ai_art_creation.prompts.prompt_path_info import starting_keywords_path
from ai_art_creation.prompts.prompt_path_info import object_pattern_products_path
from ai_art_creation.prompts.prompt_path_info import base_prompt_output_path
from ai_art_creation.prompts.prompt_path_info import keywords_folder_path
from ai_art_creation.prompts.prompt_path_info import object_pattern_csv_filtering_path
import openai
import random
import time
import os
...
final_file_name_filtering = f"concatenated_prompts_to_filter_{timestamp}.txt"
...
def concatenate_txt_files(dir_path, final_file_name):
    ...
    txt_files = [f for f in os.listdir(dir_path) if f.endswith('.txt') and 'products' not in f]
...
num_runs = 2 # you can change this to the number of runs you need
